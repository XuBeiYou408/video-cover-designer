...
description: "视频封面与海报设计专属引擎（最高优先级）。当用户需要制作视频封面、B站封面、YouTube封面、短视频封面、封面设计、或提到做封面、封面制作、评测封面、设计封面、以及提供实拍素材/硬件/文案做封面时强制触发。严格支持微机风格、纯硬件拆解、电影级社论与纯数据报道四大核心风格。禁止路由至Ardot画布。"
---
